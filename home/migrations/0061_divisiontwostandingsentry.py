# Generated by Django 4.2.15 on 2024-08-21 14:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0060_divisiononestandingsentry_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='DivisionTwoStandingsEntry',
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='div2_results', to='home.threelegstandingspage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
